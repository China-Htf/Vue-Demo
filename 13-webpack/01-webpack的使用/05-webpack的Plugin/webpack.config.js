...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      // 不会按默认方式去寻找vue，而是按照我们定义的路径
      'vue$': 'vue/dist/vue.esm.js'
    }
  },
  plugins: [
    new webpack.BannerPlugin('最终版权归某某所有'),
    new HtmlWebpackPlugin({
      template: 'index.html'
    }),
    new UglifyjsWebpackPlugin()
  ],
  devServer: {                                  //devServer也是作为webpack中的一个选项，选项本身可设置如下属性
    contentBase: './dist',                     //为哪一个文件夹服务 默认是根文件夹 我们填写./dist
    inline: true                              //页面实时刷新
  }
}